...
def getAuthSignature():
    ...
    try:
        ...
        log_debug(f"Auth ping full response: {json.dumps(result, indent=2)}", "getAuthSignature")
...
def notify(message, heading="Info", icon=xbmcgui.NOTIFICATION_INFO, time_ms=3000):
    """
...
def export_favorites():
    ...
    Saves as Oracle-Favorites-YYYY-MM-DD.json.
    """
    ...
    filename = f"Oracle-Favorites-{date_str}.json"
